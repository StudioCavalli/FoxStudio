...
export const PROJECTS: ProjectSeed[] = [
...

  {
    ...
    results: [
      { value: "< 30 ms", label: tri("latence end-to-end", "end-to-end latency", "latenza end-to-end") },
      { value: "4K · 60", label: tri("résolution / fps", "resolution / fps", "risoluzione / fps") },
      { value: "3", label: tri("régions de serveurs", "server regions", "regioni server") },
    ],
  },
];
